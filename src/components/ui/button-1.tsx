...
// Orange-themed palette (replaces the demo's blue).
export const ORANGE_COLORS: Colors = {
  color1: '#FFFFFF',
  color2: '#C2410C',
  color3: '#FB923C',
  color4: '#FFEDD5',
...
// Muted minimal palette — mostly dark with subtle orange undertones.
export const MINIMAL_COLORS: Colors = {
  color1: '#2a2a2a',
  color2: '#2a1810',
  color3: '#3a2418',
  color4: '#1f1f1f',
